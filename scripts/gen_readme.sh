echo "`ls -A ../directory/`" > ../domains.txt
...
echo "| :----: | :----: |" >> ../README.md
echo "| DOMAINS | `ls -A ../directory/ | wc -l` |" >> ../README.md
...
echo "| DOMAIN | SUBENUM | PORTENUM | WEBENUM | ASNENUM | DNSENUM | HEADENUM | FAVSCAN | CVESCAN | VULNSCAN | SUBSCAN |" >> ../README.md
echo "| :----: | :----: | :----: | :----: | :----: | :----: | :----: | :----: | :----: | :----: | :----: |" >> ../README.md
for i in `ls ../directory`
    do
        echo "| $i | `cat ../directory/$i/subenum.kenz 2>/dev/null | wc -l` | `cat ../directory/$i/portenum.kenz 2>/dev/null | wc -l` | `cat ../directory/$i/webenum.kenz 2>/dev/null | wc -l` | `cat ../directory/$i/asnenum.kenz 2>/dev/null | wc -l` | `cat ../directory/$i/dnsenum.kenz 2>/dev/null | wc -l` | `cat ../directory/$i/headenum.kenz 2>/dev/null | wc -l` | `cat ../directory/$i/favscan.kenz 2>/dev/null | wc -l` | `cat ../directory/$i/cvescan.kenz 2>/dev/null | wc -l` | `cat ../directory/$i/vulnscan.kenz 2>/dev/null | wc -l` | `cat ../directory/$i/subscan.kenz 2>/dev/null | wc -l` |" >> ../README.md
    done